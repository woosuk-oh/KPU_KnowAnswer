...
h1, h2, h3, h4, h5, h6, p {
	margin-top: 0;
	/* 위쪽 여백을 제거하면 포함된 블록에서 여백이 이스케이프되는 문제를 방지할 수 있습니다. 나머지 아래쪽 여백은 이어지는 요소에서 이 문제를 보류합니다. */
	padding-right: 15px;
	padding-left: 15px;
	/* 블록 요소에 직접 추가하는 대신 블록 내에 있는 요소의 측면에 패딩을 추가하면 상자 모델 수학이 제거됩니다. 측면 패딩이 있는 중첩된 블록을 대체 메서드로 사용할 수도 있습니다. */
	text-align: center;
}
...
ul.nav a, ul.nav a:visited {
	...
	width: 160px;
	/*이 폭은 IE6에서 전체 버튼을 클릭할 수 있도록 합니다. IE6를 지원할 필요가 없는 경우에는 제거할 수 있습니다. 사이드바 컨테이너의 폭에서 이 링크의 패딩을 제외함으로써 올바른 폭을 계산합니다. */
	text-decoration: none;
...
/* ~~ 기타 부동/클래스 지우기 ~~ */
.fltrt {
	/* 이 클래스는 페이지에서 오른쪽 요소를 부동화하는 데 사용될 수 있습니다. 부동화된 요소는 페이지에서 옆에 있는 다른 요소의 앞쪽에 배치되어야 합니다. */
	float: right;
	margin-left: 8px;
}

.clearfloat {
	/* .container에서 바닥글이 제거되거나 없어진 경우 이 클래스는 마지막 부동 블록(.container 내) 뒤에 오는 최종 요소로 <br /> 또는 빈 블록 요소에 배치될 수 있습니다. */
	clear: both;
	height: 0;
	font-size: 1px;
	line-height: 0px;
...
<body>
	...
	<%
		//Console 진행 사항 체크
		System.out.println("***********************[Stage 진입 완료] ");
	%>
	<div id="panel">
		<div class="container">
			<header></header>
			<footer>
				<a href="#"><a href="#"><img
						src="https://s3.ap-northeast-2.amazonaws.com/p2pprojectmory/title.png"
						alt="여기에 로고 삽입" width="500"
						height="100
                                        "
						id="Insert_logo2"
						style="background-color: #FFFFFF; display: block; color: #0000CC;"
						align="middle" /></a><a href="#"></a>
					<div id="ground">

						<table id="abc width=" 150" align="center">
							<tr>
								<td width="302">&nbsp;</td>
								<td width="181" rowspan="3"><p>
										<span style="text-align: center" href="#"></span><span
											style="text-align: center" href="#"></span>
									</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									...
									<p>
										<a href="#"><img
											src="https://s3.ap-northeast-2.amazonaws.com/p2pprojectmory/logo2.png"
											alt="여기에 로고 삽입" width="200" height="100" id="Insert_logo"
											style="background-color: #FFFFFF; display: block; color: #0000CC;"
											align="middle" /></a>
									</p></td>
								<td width="325">&nbsp;</td>
							...
							<tr>
								<!--  첫번째 시나리오   -->
								<td align="center" height="204"><img
									src="https://s3.ap-northeast-2.amazonaws.com/p2pprojectmory/mission01.png"
									width="300" height="150"><br>

									<form action="bird_mission/step_check.jsp">
										<input type="hidden" name=stepdata value=<%=step%>> <input
											type="submit" class="btn btn-danger" value="시작하기"><br>
									</form>

									<form action="bird_mission/ResetStep.jsp">
										<input type="hidden" name=stepdata value=<%=step%>> <input
											type="submit" class="btn btn-default" value="문제처음부터풀기">
										<br>현재 진행 중인 단계 : <b><%=step%></b>
									</form></td>
								<!--  첫번째 시나리오 끝  -->
								<!--  두번째 시나리오    -->
								<td align="center" height="204">

									<p>
										<img
											src="https://s3.ap-northeast-2.amazonaws.com/p2pprojectmory/mission02.png"
											width="300" height="150"><br>
									</p>
									<form action="second_mission/step_check.jsp">
										<input type="hidden" name=stepdata value=<%=step1%>> <input
											type="submit" class="btn btn-danger" value="시작하기"><br>
									</form>
									<form action="second_mission/ResetStep.jsp">
										<input type="hidden" name=stepdata value=<%=step1%>> <input
											type="submit" class="btn btn-default" value="문제처음부터풀기">
										<br>현재 진행 중인 단계 : <b><%=step1%></b>
									</form>
								</td>
							</tr>
							<!--  두번째 시나리오 끝  -->
							<tr>
								...
								<td align="center" height="204">
									...
									<p>
										<img
											src="https://s3.ap-northeast-2.amazonaws.com/p2pprojectmory/mission03.png"
											width="300" height="150"><br>
									</p>
									<form action="">
										<input type="hidden" name=stepdata value=<%=step1%>> <input
								...
								<td align="center" height="204">
									...
									<p>
										<img
											src="https://s3.ap-northeast-2.amazonaws.com/p2pprojectmory/mission04.png"
											width="300" height="150"><br>
									</p>
									<form action="">
										<input type="hidden" name=stepdata value=<%=step1%>> <input
						...
						<form action="index.jsp">
							...
							<div id="submit" align="center">
								<input type="submit" class="btn btn-warning" value="처음으로"><br>
								<form action="ex01Pro.jsp">
									2017 © <strong>KNOW ANSWER</strong>
								</form>
